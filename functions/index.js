...
function getSummaryData(callback) {
    ...
    getFullData(scoutDF => {
    	...
    	summaryDataFrame = scoutDF.groupBy('Team_#').aggregate(group => (6*group.stat.mean('Inner Port Auto') + 4*group.stat.mean('Outer Port Auto') + 2*group.stat.mean('Bottom Port Auto') + 3*group.stat.mean('Inner Port TeleOp') + 2*group.stat.mean('Outer Port TeleOp') + group.stat.mean('Bottom Port TeleOp') + "/" + group.count()), 'avg', 'avg');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Inner Port Auto') + group.stat.sum('Inner Port TeleOp') + "/" + group.count()), 'inner'), 'Team_#', 'avg', 'inner');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Outer Port Auto') + group.stat.sum('Outer Port TeleOp') + "/" + group.count()), 'outer'),'Team_#', 'Team_#', 'avg', 'inner', 'outer');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Bottom Port Auto') + group.stat.sum('Bottom Port TeleOp') + "/" + group.count()), 'bottom'), 'Team_#', 'avg', 'inner', 'outer', 'bottom');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Rotation Control') * 100 + "%"), 'rotation'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Position Control') * 100 + "%"), 'position'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation', 'position');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Hang') * 100 + "%"), 'hang'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation', 'position','hang');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Avg Points Defended')), 'defended'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation', 'position', 'hang', 'defended');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Played Defense')), 'undefended'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation', 'position', 'hang', 'defended', 'undefended');
        summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Played Defense')), 'defense'),'Team_#', 'avg', 'inner', 'outer', 'bottom', 'rotation', 'position', 'hang', 'defended', 'undefended', 'defense'); 
...
//         // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Penalties') + "/" + group.count()), 'penalties'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl', 'hab-lvl1', 'hab-lvl2', 'hab-lvl3', 'penalties');
			...
			// summaryDataFrame = scoutDF.groupBy('Team_#').aggregate(group => (6*group.stat.mean('Inner Port Auto') + 4*group.stat.mean('Outer Port Auto') + 2*group.stat.mean('Bottom Port Auto') + 3*group.stat.mean('Inner Port TeleOp') + 2*group.stat.mean('Outer Port TeleOp') + group.stat.mean('Bottom Port TeleOp') + "/" + group.count()), 'avg');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Inner Port Auto') + group.stat.sum('Inner Port TeleOp') + "/" + group.count()), 'Team_#', 'avg', 'inner');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Outer Port Auto') + group.stat.sum('Outer Port TeleOp') + "/" + group.count()), 'hch-scrd-rkt'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Bottom Port Auto') + group.stat.sum('Bottom Port TeleOp') + "/" + group.count()), 'crg-scrd-csh'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-csh');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Rotation Control') * 100 + "%"), 'hch-scrd-csh'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Position Control') * 100 + "%"), 'scrd-both'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Hang') * 100 + "%"), 'start-hablvl'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.mean('Avg Points Defended')), 'hab-lvl1'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl', 'hab-lvl1');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Played Defense')), 'hab-lvl2'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl', 'hab-lvl1', 'hab-lvl2');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Played Defense')), 'hab-lvl3'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl', 'hab-lvl1', 'hab-lvl2', 'hab-lvl3');
        // summaryDataFrame = summaryDataFrame.innerJoin(scoutDF.groupBy('Team_#').aggregate(group => (group.stat.sum('Penalties') + "/" + group.count()), 'penalties'),'Team_#', 'max-score', 'crg-scrd-rkt', 'hch-scrd-rkt', 'crg-scrd-rkt', 'hch-scrd-csh',/* 'grnd-pkup',*/ 'scrd-both', 'start-hablvl', 'hab-lvl1', 'hab-lvl2', 'hab-lvl3', 'penalties');
